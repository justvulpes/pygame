...
upgrade_cost = {0: {"coins": 75, "stone": 75, "wood": 55}, 1: {"coins": 90, "stone": 90, "wood": 70}, 2: {"coins": 60, "stone": 60, "wood": 60}, 3: {"coins": 50, "stone": 40, "wood": 80}}
background = pygame.Surface((64, 96), pygame.SRCALPHA)
background.fill((0, 0, 0, 170))


class Hut(objects.building.Building.Building):
    def __init__(self, x, y):
        ...
        self.tower_text = self.font.render(" Hut", 1, self.font_color)
        ...
        if Main.gamestate.coins >= upgrade_cost[self.lvl]["coins"] and Main.gamestate.stone >= upgrade_cost[self.lvl]["stone"] and Main.gamestate.wood >= upgrade_cost[self.lvl]["wood"]:
            if self.no_mobs():
                if not self.constructed:
                    ...
                    Main.world.mobs.append(Main.worker_man2)
